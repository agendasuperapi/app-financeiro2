  ...
  if (!isAdmin) {
    return (
      <Card>
        ...
        <CardContent>
          <p className="text-gray-600">Você não tem permissões para acessar as configurações de branding.</p>
        </CardContent>
      </Card>
    );
  }
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                disabled={isUpdating}
              />
              {logoFile && <p className="text-sm text-green-600">Nova logo selecionada: {logoFile.name}</p>}
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="Logo da empresa App Financeiro"
                disabled={isUpdating}
              />
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                disabled={isUpdating}
              />
              {faviconFile && <p className="text-sm text-green-600">Novo favicon selecionado: {faviconFile.name}</p>}
              <p className="text-xs text-gray-500">Recomendado: imagem quadrada, mínimo 32x32px</p>
            </div>
          </div>
