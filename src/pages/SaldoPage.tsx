  ...
  return <MainLayout>
      <div className="p-6">
        ...
        {accountBalances.length === 0 ? <Card>
            ...
            {accountBalances.map(account => <Card key={account.conta} className="hover:shadow-md transition-shadow">
                <CardHeader className="pb-2">
                ...
                <CardContent>
                  ...
                  <div className="flex items-center gap-1 mt-2">
                    {account.total >= 0 ? <TrendingUp className="h-4 w-4 text-green-600" /> : <TrendingDown className="h-4 w-4 text-red-600" />}
      ...
      <TransferModal open={isTransferModalOpen} onOpenChange={setIsTransferModalOpen} onSuccess={loadAccountBalances} />
    </MainLayout>;
};
